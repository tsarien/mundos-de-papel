...
const Cuenta = () => {
  ...
  const pedidosEjemplo = [
    { id: 1, nombre: 'Batman', fecha: '12/04/2024', estado: 'Entregado', imagen: '/productos/batman.jpg' },
    { id: 2, nombre: 'Dragon Ball', fecha: '28/03/2024', estado: 'En proceso', imagen: '/productos/dragon-ball.webp' },
  ];
        ...
        <section className="bg-white rounded-2xl shadow-md p-10 min-w-0">
          ...
          {seccionActiva === 'info' && (
            <div>
              ...
              <form onSubmit={handleSubmit(onSubmitInfo)} className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl">
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Nombre completo</span>
                  <input
                    type="text"
                    {...register('nombre')}
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Apellido</span>
                  <input
                    type="text"
                    {...register('apellido')}
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Email</span>
                  <input
                    type="email"
                    {...register('email')}
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Teléfono</span>
                  <input
                    type="tel"
                    {...register('telefono')}
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                ...
                <label className="flex flex-col gap-1 col-span-full">
                  <span className="text-base font-semibold text-accent-purple">Dirección</span>
                  <input
                    type="text"
                    {...register('direccion')}
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
            ...
            <div>
              ...
              <ul className="list-none m-0 p-0 flex flex-col gap-5">
                {pedidosEjemplo.map(pedido => (
                  <li key={pedido.id} className="flex items-center gap-5 bg-gray-100 rounded-xl p-5 shadow-sm justify-between">
                    <img src={pedido.imagen} alt={pedido.nombre} className="w-15 h-15 rounded-lg object-cover" />
                    <div className="flex-1">
                      <span className="font-bold text-accent-blue text-base block">{pedido.nombre}</span>
                      <span className="text-accent-pink text-sm mr-3">{pedido.fecha}</span>
                      <span className={`text-sm font-semibold rounded-lg py-1 px-3 ml-2 ${
                        pedido.estado === 'Entregado' ? 'bg-accent-blue text-white' : 'bg-accent-pink text-white'
                      }`}>
                        {pedido.estado}
                      </span>
                    </div>
          ...
          {seccionActiva === 'password' && (
            <div>
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl">
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Contraseña actual</span>
                  <input
                    type="password"
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                  />
                ...
                <label className="flex flex-col gap-1">
                  <span className="text-base font-semibold text-accent-purple">Nueva contraseña</span>
                  <input
                    type="password"
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                  />
                ...
                <label className="flex flex-col gap-1 col-span-full">
                  <span className="text-base font-semibold text-accent-purple">Confirmar nueva contraseña</span>
                  <input
                    type="password"
                    className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
                  />
