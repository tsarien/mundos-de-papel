...
const Registro = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-bg py-10">
      <header className="w-full max-w-[420px] flex items-center justify-between mb-10 px-4">
        <div className="flex items-center gap-3">
          <div className="h-[54px] w-[54px] rounded-full overflow-hidden border-[2.5px] border-accent-blue bg-white">
            <div className="w-full h-full bg-gradient-to-br from-accent-purple to-accent-pink" />
          </div>
          <span className="font-poppins font-bold text-lg text-accent-blue tracking-wide">
            Mundos de Papel
          </span>
        </div>
        <Link to="/login" className="text-accent-purple text-base font-semibold no-underline hover:text-accent-pink hover:underline transition-colors">
          Iniciar sesión
        </Link>
      </header>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl shadow-xl p-10 flex flex-col gap-5 w-full">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="flex flex-col gap-1">
              <label htmlFor="usuario" className="text-base font-semibold text-accent-purple">
                Usuario
              </label>
              <input
                type="text"
              ...
              />
              {errors.usuario && <span className="text-red-500 text-xs">{errors.usuario.message}</span>}
            </div>

            <div className="flex flex-col gap-1">
              <label htmlFor="nombres" className="text-base font-semibold text-accent-purple">
                Nombres
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="apellidos" className="text-base font-semibold text-accent-purple">
                Apellidos
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cedula" className="text-base font-semibold text-accent-purple">
                Cédula
              </label>
              <input
                type="number"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="email" className="text-base font-semibold text-accent-purple">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="fecha" className="text-base font-semibold text-accent-purple">
                Fecha de nacimiento
              </label>
              <input
                type="date"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="password" className="text-base font-semibold text-accent-purple">
                Contraseña
              </label>
              <input
                type="password"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="password2" className="text-base font-semibold text-accent-purple">
              ...
              <input
                ...
                className="py-3 px-4 rounded-lg border border-gray-300 text-base bg-gray-100 text-gray-800 mt-1 outline-none focus:border-accent-pink transition-colors"
              />
              {errors.password2 && <span className="text-red-500 text-xs">{errors.password2.message}</span>}
            </div>
          </div>
          ...
          <div className="flex justify-center items-center mt-5">
            <Link to="/login" className="text-accent-purple text-sm font-semibold no-underline hover:text-accent-pink hover:underline transition-colors">
